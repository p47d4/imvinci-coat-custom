  ...
  return (
    <section id="shop" className="py-20 bg-gradient-to-b from-white to-gray-50">
      <div className="container mx-auto px-4">
        <div className="text-center mb-16">
          <div className="flex items-center justify-center mb-4">
            ...
            <h2 className="text-4xl md:text-5xl font-bold text-black">
              Shop <span className="bg-gradient-to-r from-red-600 to-red-800 bg-clip-text text-transparent">Products</span>
            </h2>
          </div>
            ...
            <button
              ...
              className={`px-6 py-3 rounded-full font-semibold transition-all duration-300 ${
                selectedCategory === category
                  ...
                  : 'bg-white text-gray-700 border-2 border-gray-200 hover:border-red-400 hover:bg-gray-50'
              }`}
            >
              {category}
            </button>
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <button
                    ...
                    className="bg-gradient-to-r from-red-600 to-red-800 hover:from-red-700 hover:to-red-900 text-white px-6 py-2 rounded-full font-semibold transition-all duration-300 transform hover:scale-105 flex items-center gap-2"
                  >
        ...
        {/* Cart Summary */}
        {cart.length > 0 && (
          <div className="fixed bottom-6 right-6 bg-gradient-to-r from-red-600 to-red-800 text-white px-6 py-4 rounded-2xl shadow-2xl">
            <div className="flex items-center gap-3">
              <ShoppingCart className="w-6 h-6" />
              <span className="font-semibold">{cart.length} items in cart</span>
              <button className="bg-white text-red-600 px-4 py-2 rounded-full font-semibold hover:bg-gray-50 transition-colors">
                View Cart
              </button>
            </div>
          </div>
